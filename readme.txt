...
Extracts a tracklist from a remote feed (radio stations websites, music services, xml/rss/json/...); and generate a [XSPF](http://en.wikipedia.org/wiki/XSPF/) playlist that stays synced with your source.
...
* Stats
* Cache engine
* Optional : validate a tracklist with [MusicBrainz](http://musicbrainz.org/) (slower)
